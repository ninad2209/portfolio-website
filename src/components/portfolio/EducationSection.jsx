...
const education = [
  ...
  period: '2025-2027',
  description: 'Gained foundational knowledge in cybersecurity, including cryptography, encryption/decryption techniques, and key security principles. Developed practical experience in IT forensics and web security with a focus on ethical practices.',
  highlights: ['Cryptography', 'Digital Forensics (Autopsy, Wireshark)', 'Web Security (SQLi, Authentication)', 'Privacy-Enhancing Technologies'],
},
  {
    degree: 'Masters in Computer Applications',
    institution: 'MIT-World Peace University',
    period: '2022 — 2024',
    description: 'Comprehensive curriculum covering software development, data structures, algorithms, and system design. Completed projects in web development, machine learning, and database management.',
    highlights: ['Software Development', 'Data Structures & Algorithms', 'Web Development (React, Node.js)', 'Machine Learning (Python, scikit-learn)','Cloud Computing (AWS)'],
  },
];
