        ...
        <div className="flex flex-col lg:flex-row justify-between gap-12 mb-16">
          ...
          >
            ...
            <div className="mt-4 flex items-center gap-2">
              ...
              <span className="font-mono text-[10px] text-muted-foreground">Available for projects</span>
            </div>
          </motion.div>
          ...
          >
            <p className="font-mono text-[10px] tracking-[0.2em] uppercase text-muted-foreground mb-4">Navigation</p>
          ...
          >
            <p className="font-mono text-[10px] tracking-[0.2em] uppercase text-muted-foreground mb-4">Find me on</p>
            <div className="flex flex-col gap-3">
          ...
          <motion.div
            ...
            className="max-w-xs"
          >
            <p className="font-mono text-[10px] tracking-[0.2em] uppercase text-muted-foreground mb-4">Let's collaborate</p>
